...
export default function Hero() {
    return (
        <section className="relative min-h-screen flex flex-col justify-center items-center overflow-hidden bg-[#0D0005]">
            ...
            <div className="relative z-10 flex flex-col items-center text-center px-4 w-full">
                ...
                <motion.h1
                    ...
                    className="font-cinzelDecorative text-[#D4AF37] leading-tight mb-6"
                    style={{
                ...
                <motion.div
                    ...
                    className="inline-flex items-center gap-3 px-6 py-2 border border-[rgba(212,175,55,0.4)] rounded-full bg-[rgba(212,175,55,0.05)] mb-14"
                >
                    <span className="text-xl">🦁</span>
                    <span className="font-cinzel text-sm uppercase tracking-widest text-[#D4AF37]">
                ...
                >
                    ...
                    >
                        <span className="text-lg">🗺</span> Marauder&apos;s Map
                    </button>
                </motion.div>
            </div>
